...
class CWeaponZRLong : public CWeaponHL2MPBase
{
public:
	DECLARE_CLASS( CWeaponZRLong, CWeaponHL2MPBase );
...
void CWeaponZRLong::AddViewKick( void )
{
	...
	DoMachineGunKick( pPlayer, EASY_DAMPEN, MAX_VERTICAL_KICK, 3.0f, SLIDE_LIMIT );
}