...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMPNSilenced::Precache( void )
{
#ifndef CLIENT_DLL
...
//-----------------------------------------------------------------------------
void CWeaponMPNSilenced::Equip( CBaseCombatCharacter *pOwner )
{
	m_fMaxRange1 = 1400;
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CWeaponMPNSilenced::Reload( void )
{
	bool fRet;
...
//-----------------------------------------------------------------------------
void CWeaponMPNSilenced::SecondaryAttack( void )
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CWeaponMPNSilenced::GetProficiencyValues()
{
