...
class CWeaponSRMSilenced : public CHL2MPMachineGun
{
public:
	DECLARE_CLASS( CWeaponSRMSilenced, CHL2MPMachineGun );
	...
	float	GetFireRate( void ) { return 0.080f; }
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponSRMSilenced::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
