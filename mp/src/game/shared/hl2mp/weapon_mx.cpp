...
class CWeaponMX : public CHL2MPMachineGun
{
public:
	DECLARE_CLASS( CWeaponMX, CHL2MPMachineGun );
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponMX::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMX::AddViewKick( void )
{
